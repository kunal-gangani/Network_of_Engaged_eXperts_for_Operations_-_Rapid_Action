...
import {
  ...
  Plus, FileText, LogOut, LogIn, Bot, ChevronRight
} from 'lucide-react'
  ...
  return (
    ...
    >
      ...
      <div className="px-5 py-5 border-b" style={{ borderColor: '#1E2D4A' }}>
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-xs" style={{ color: '#4A6080', fontSize: '9px', letterSpacing: '0.05em' }}>
              CIVIC INTELLIGENCE
            </p>
          </div>
        </div>
      ...
      <nav className="flex-1 px-3 py-4 space-y-0.5">
        <p className="text-xs font-semibold px-2 mb-3 tracking-widest" style={{ color: '#2D4266', fontSize: '10px' }}>
          PLATFORM
        </p>
